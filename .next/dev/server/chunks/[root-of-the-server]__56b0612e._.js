...
async function POST(request) {
    try {
        ...
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["encrypt"])({
            user: {
                id: user.id,
                email: user.email,
                name: user.name
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56b0612e._.js.map