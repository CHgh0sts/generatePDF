...
export default function EditRoutePage() {
  ...
  const fetchRoute = async () => {
    try {
      ...
      const route: ApiRoute = await res.json();
      ...
      try {
        ...
        const mappingArray = Object.entries(mapping).map(([jsonPath, templateVar]) => ({
          ...
          jsonPath,
          templateVar: templateVar as string
        }));
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Modifier la Route API</h1>
        <p className="text-gray-700 mt-2">Modifiez la configuration de votre route</p>
      </div>
